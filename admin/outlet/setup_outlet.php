...
<div class="row">
	<div class="col-lg-6">
		<div class="card">
			<h5 class="card-title"><strong>Setup Outlet</strong></h5>
				...
				<form id="new_entry">
					<div data-provide="wizard" data-navigateable="true">
						...
						<div class="tab-content">
							<div class="tab-pane fade active show" id="serving-time">
								<div class="card-body row">
									<div class="col-md-12">
										<h6 class="text-uppercase">New Outlet</h6>
										<hr class="hr-sm mb-2">
						...
						<div class="card-footer">
							<div class="flexbox">
								<button id="save" type="button" class="btn btn-primary d-none" data-wizard="finish">ADD</button>
							</div>
						</div>
					</div>
				</form>
